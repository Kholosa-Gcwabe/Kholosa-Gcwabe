...
// Variables  
let name = "Kholosa";   
const Education = Walter Sisulu University (Diploma in ICT in Application Development); 

// Data types
let isDeveloper = true;  
let LetCurrentRole = Subject Matter Expert (SME) At WNS Global Services;  
let skills = ["JavaScript", "React", "Java" , "C#"];    
let person = { // Object  
 firstName: "Kholosa",  
 lastName: "Gcwabe",  
